...
import { getSetting, setSetting, insertScopeItem, deleteScopeItem, listScopeItems } from './store.sqlite'
import type { ProjectScope, ScopeItem, ScopeItemType } from './store.types'
